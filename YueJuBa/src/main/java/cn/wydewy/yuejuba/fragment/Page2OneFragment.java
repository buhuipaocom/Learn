...
import cn.wydewy.yuejuba.adapter.Page1FiveAdapter;

public class Page2OneFragment extends Fragment implements IReflashListener, ILoadListener {

	private VniqueListView lv;
	private Page1FiveAdapter adapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		adapter = new Page1FiveAdapter(getActivity());
