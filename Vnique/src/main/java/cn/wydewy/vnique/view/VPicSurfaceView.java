...
public class VPicSurfaceView extends SurfaceView implements
	...
	public VPicSurfaceView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setBitmap(Bitmap b) {
		...
		synchronized (VPicSurfaceView.class) {
			mBitmap = b;
