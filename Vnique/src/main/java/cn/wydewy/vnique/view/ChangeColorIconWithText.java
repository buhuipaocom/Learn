...
public class ChangeColorIconWithText extends View {
	...
	private int mColor = 0xFF00A7FF;
	private Bitmap mIconBitmap;
	private String mText = "";
	private int mTextColor = 0xFF161616;
	...
	public ChangeColorIconWithText(Context context, AttributeSet attrs,
		...
		for (int i = 0; i < n; i++) {
			...
			case R.styleable.ChangeColorIconWithText_color:
				mColor = a.getColor(attr, 0xFF00A7FF);
				break;
			case R.styleable.ChangeColorIconWithText_text_color:
				mTextColor = a.getColor(attr, 0xFF161616);
				break;
	...
	private void drawTargetText(Canvas canvas, int alpha) {
		...
		int y;
		if (mIconBitmap != null && mBitmap != null) {
